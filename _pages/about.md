...
I received the `Erasmus Mundus` scholarship grant in 2017 and was accepted to the `Google Africa Developers` Program in 2021. Prior to that, I was awarded the Outstanding Academic Accomplishment award by `Dr. Bukola Saraki Foundation` in 2016, `NIIT` scholarship in 2015 and `Kingshouse Learning Center` to study Computer Engineering in 2012.
